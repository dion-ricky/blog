...
},{}],"scripts/icon.js":[function(require,module,exports) {
var changeIcon = function changeIcon(el, icon) {
  el.innerHTML = icon;
  el.childNodes[0].style = "display: inline";
};

var fetchIcon = function fetchIcon(icon) {
  return new Promise(function (res, rej) {
    var proto = window.location.protocol;
    var host = window.location.host;
    var iconPath = proto + '//' + host + '/' + icon;
    fetch(iconPath).then(function (res) {
      return res.text();
    }).then(function (data) {
      res(data);
    });
...
// =============================================
// date-fns
console.log((0, _dateFns.format)(new Date(), "'Today is a' iiii"));
console.log((0, _dateFns.formatDistance)((0, _dateFns.subDays)(new Date(), 3), new Date()));
console.log((0, _dateFns.formatRelative)((0, _dateFns.subDays)(new Date(), 3), new Date())); // =============================================
// Replace icon

document.addEventListener('DOMContentLoaded', function () {
  var iconPool = {};
  document.querySelectorAll('icon').forEach(function (el) {
    var icon = el.getAttribute('src');
    iconPool[icon] = !(icon in iconPool) ? [el] : [].concat(_toConsumableArray(iconPool[icon]), [el]);
  });

  var _loop = function _loop(icon) {
    (0, _icon.fetchIcon)(icon).then(function (data) {
      iconPool[icon].forEach(function (el) {
        (0, _icon.changeIcon)(el, data);
      });
    });
  };

  for (var icon in iconPool) {
    _loop(icon);
  }
});
},{"regenerator-runtime/runtime":"../node_modules/regenerator-runtime/runtime.js","./icon":"scripts/icon.js","date-fns":"../node_modules/date-fns/esm/index.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "8082" + '/');
